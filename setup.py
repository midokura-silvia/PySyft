...
if "REQUIREMENTS_SYFT" in os.environ:
    core_reqs_file = os.environ["REQUIREMENTS_SYFT"]
else:
    core_reqs_file = "requirements.txt"
core_reqs = read(os.path.join(REQ_DIR, core_reqs_file)).split("\n")
